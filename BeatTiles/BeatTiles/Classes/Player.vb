...
#Region "CurrentMedia"
    ...
    ''' </summary>
    ''' <returns></returns>
    Public Property CurrentMediaInfo As String()
#End Region
#End Region
#Region "Boot"
            ...
            Else
                ...
                Try
                    ...
                    If BassFx.BASS_FX_GetVersion() = 0 Then
                        RaiseEvent EngineError(Engines.BASS_FX, Bass.BASS_ErrorGetCode)
                        StartUpErrors.Add(Engines.BASS_FX)
                    End If
                ...
                Try
                    ...
                    If BassSfx.BASS_SFX_GetVersion() = 0 Then
                        RaiseEvent EngineError(Engines.BASS_SFX, Bass.BASS_ErrorGetCode)
                        StartUpErrors.Add(Engines.BASS_SFX)
                    End If
                Catch ex As Exception
                    RaiseEvent EngineError(Engines.BASS_SFX, Bass.BASS_ErrorGetCode)
                    StartUpErrors.Add(Engines.BASS_SFX)
                ...
                Try
                    ...
                    If BassWaDsp.BASS_WADSP_GetVersion = 0 Then
                        RaiseEvent EngineError(Engines.BASS_WADSP, Bass.BASS_ErrorGetCode)
                        StartUpErrors.Add(Engines.BASS_WADSP)
                    Else
                        If Not BassWaDsp.BASS_WADSP_Init(Hwnd.Handle) Then
                            RaiseEvent EngineError(Engines.BASS_WADSP, Bass.BASS_ErrorGetCode)
                            StartUpErrors.Add(Engines.BASS_WADSP)
                        End If
                    End If
                ...
                Try
                    ...
                    If BassMidi_Handle = 0 Then
                        RaiseEvent EngineError(Engines.BASS_MIDI, Bass.BASS_ErrorGetCode)
                        StartUpErrors.Add(Engines.BASS_MIDI)
                    End If
                Catch ex As Exception
                    RaiseEvent EngineError(Engines.BASS_MIDI, Bass.BASS_ErrorGetCode)
                    StartUpErrors.Add(Engines.BASS_MIDI)
